...
> Condensed by mcwrench/learn-plugin-docs from <https://modrinth.com/mod/openinv>. Full text in RAW.md. Verify against the live docs for anything safety-critical.
