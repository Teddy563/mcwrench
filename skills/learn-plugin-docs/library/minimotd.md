...
> Condensed by mcwrench/learn-plugin-docs from <https://modrinth.com/mod/minimotd>. Full text in RAW.md. Verify against the live docs for anything safety-critical.
...
## MiniMOTD
Minecraft plugin/mod to set the server list MOTD using MiniMessage for formatting, supporting RGB colors. 
