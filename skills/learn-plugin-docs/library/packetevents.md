...
> Condensed by mcwrench/learn-plugin-docs from <https://modrinth.com/mod/packetevents>. Full text in RAW.md. Verify against the live docs for anything safety-critical.
