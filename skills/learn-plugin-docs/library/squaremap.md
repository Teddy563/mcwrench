...
> Condensed by mcwrench/learn-plugin-docs from <https://modrinth.com/mod/squaremap>. Full text in RAW.md. Verify against the live docs for anything safety-critical.
...
## squaremap
squaremap is a minimalistic & lightweight world map viewer for Minecraft servers, using the vanilla map rendering style
